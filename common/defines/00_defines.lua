...
NDiplomacy = {
	...
	MAX_FEAR_VALUE = 200,							-- Max fear value cap.
	MIN_FEAR_VALUE = -200,							-- Min fear  value cap.
	...
	BASE_TRUST_FACTOR = 200,						-- Base trust factor in % for opinion.
...
NCountry = {
	...
	POLITICAL_POWER_CAP = 300.0,					-- Max amount of political power country should have
