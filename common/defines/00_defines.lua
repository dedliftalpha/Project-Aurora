...
NDiplomacy = {
	...
	BASE_PEACE_TAKE_UNCONTROLLED_STATE_FACTOR = 100,-- Base factor for taking state you do not control in %
	...
	PEACE_SCORE_PER_PASS = 0.5,						-- When you pass in a peace deal you gain this percent of your original score
...
NCountry = {
	EVENT_PROCESS_OFFSET = 5,						-- Events are checked every X day per character or province (1 is ideal, but CPU heavy)
	...
	POLITICAL_POWER_CAP = 400.0,					-- Max amount of political power country should have
	...
	STATE_VALUE_BUILDING_SLOTS_MULT = 0.1,			-- The Value of each building slot in a state ( Value is used to determine costs in peace conference and PP cost to occupy )
	STATE_VALUE_RESEOURCE_MULT = 0.1,				-- The Value of each resource in a state ( Value is used to determine costs in peace conference and PP cost to occupy)
...
NTrade = {
	...
	FEAR_TRADE_FACTOR = 1,
	ALLOW_TRADE_CUT_OFF = 50,				-- If trade factor is less than this, no trade will be allowed
...
NAI = {
	...
	DIPLOMACY_SEND_EXPEDITIONARY_BASE = 0,		-- Multiplied with relative strength factor to get result (if other is twice as "strong" the result with 25 would be 50)
